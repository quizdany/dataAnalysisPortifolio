...
-- 1. GDP Growth Trend
-- Use this query to create a line chart of GDP growth over time
SELECT year, gdp_growth FROM economic_indicators ORDER BY year;

-- 2. Population vs. Urbanization
-- Use this query to create a dual-axis chart showing population growth and urbanization rate
SELECT year, total_population, urban_population_percent 
FROM demographic_indicators ORDER BY year;

-- 3. Education Enrollment Rates
-- Use this query to create a stacked bar chart of primary and secondary enrollment rates
...
-- Use this query to create a multi-line chart of health indicators
SELECT year, infant_mortality_rate, health_expenditure_percent_gdp 
FROM health_indicators ORDER BY year;

-- 5. Combined Economic and Social Indicators
-- Use this query to create a dashboard summary showing key indicators across all sectors
...
-- Calculating 5-year moving averages for key indicators
...
-- Identifying years with significant changes across multiple indicators
